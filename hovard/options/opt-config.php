...
$args = array(
	...
	'menu_title'           => esc_html__( 'Theme Settings', 'hovard' ),
	'page_title'           => esc_html__( 'Hovard Theme Settings', 'hovard' ),
...
$args['footer_text'] = '<br>'.esc_html__( 'Copyright Hovard &copy; 2021', 'hovard' );
...
require get_template_directory().'/options/opt_user_profile.php';
