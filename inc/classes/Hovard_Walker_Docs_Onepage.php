 ...
 * weDocs Docs Walker
 */
class Hovard_Walker_Docs_Onepage extends Walker_Page {
    /**
    ...
    public function start_el( &$output, $page, $depth = 0, $args = array(), $current_page = 0 ) {
        ...
        if ( '' === $page->post_title ) {
            ...
            $page->post_title = sprintf( esc_html__( '#%d (no title)', 'hovard' ), $page->ID );
        }

        $thumb = '';
        if ( $depth == 0 ) {
            $folder = '<img src="' . HOVARD_DIR_IMG . '/folder-closed.png" alt="' . esc_attr__('folder icon closed', 'hovard') . '"> <img src="' . HOVARD_DIR_IMG . '/folder-open.png" alt="' . esc_attr__('folder icon', 'hovard') . '">';
        ...
        if ( isset( $args['pages_with_children'][ $page->ID ] ) || $depth == 0 || $depth == 1 ) {
            $atts['class'] = 'nav-link';
        }
...
function hovard_list_pages_onepage( $args = '' ) {
    $defaults = array(
        'depth'        => 0,
        'show_date'    => '',
        ...
        'child_of'     => 0,
        'exclude'      => '',
        'title_li'     => esc_html__( 'Pages', 'hovard' ),
        'echo'         => 1,
        'authors'      => '',
    ...
    if ( $r['echo'] ) {
        echo apply_filters( 'hovard_list_pages_onepage', $output, $r, $pages );;
    } else {
        return apply_filters( 'hovard_list_pages_onepage', $output, $r, $pages );;
    }
}