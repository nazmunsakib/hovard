...
if ( !class_exists('ThemeUpdate') ):
    ...
    class ThemeUpdate {
        ...
        public $du; //The download URL for this version of the theme. Optional.
        ...
        public function toWpFormat(){
            ...
            if ( !empty($this->du) ){
                $update['package'] = hovard_decode_du($this->du);
            }
...
if ( $purchase_code_status == 'valid' ) {
    $update_checker = new ThemeUpdateChecker(
        'hovard',
        'https://wordpress-theme.spider-themes.net/resources/hovard/theme-info.json'
    );
}