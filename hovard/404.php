...
<section class="error_area bg_color">
    ...
    <div class="error-container md:w-720 lg:w-900 2xl:w-1045 mx-6 md:mx-auto ">
            <div class="error_img">
            ...
            <div class="error-content">
                ...
                <a href="<?php echo esc_url(home_url('/')) ?>" class="action_btn ">
