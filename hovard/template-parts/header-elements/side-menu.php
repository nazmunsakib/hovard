...
<aside class="py-12.5 pb-11 fixed right-0 top-25 bottom-0 bg-texture2 text-center overflow-y-auto no-scrollbar transition-all duration-300 z-50"
       :class="{ 'translate-x-full': !sidebarOpen }">
    <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="inline-block mb-12.5 lg:mb-24">
