 ...
 * weDocs Docs Walker
 */
class Hovard_Walker_Docs extends Walker_Page {
    /**
...
function wp_list_pages_custome( $args = '' ) {
    $defaults = array(
        'depth'        => 0,
        'show_date'    => '',
    ...
    if ( $r['echo'] ) {
        echo apply_filters( 'wp_list_pages_custome', $output, $r, $pages );;
    } else {
        return apply_filters( 'wp_list_pages_custome', $output, $r, $pages );;
    }
}